...
export const Camera: React.FC = () => {
  ...
  const [selectedVideo, setSelectedVideo] = useState<CapturedVideo | null>(
    null
  );
            ...
            <div className="camera-settings-content">
              ...
              <div className="setting-toggles">
                <button
                  className={`setting-toggle ${
                    settings.invert ? "active" : ""
                  }`}
                  onClick={() =>
                    setSettings({ ...settings, invert: !settings.invert })
                  }
                >
                  Invert
                </button>
                ...
                <button
                  ...
                  onClick={() =>
                    setSettings({ ...settings, sepia: !settings.sepia })
                  }
                >
                  Sepia
                </button>
              ...
              <div className="setting-item">
                ...
                <div className="setting-toggles resolution-toggles">
                  <button
                    className={`setting-toggle ${
                      settings.resolution === "480p" ? "active" : ""
                    }`}
                    onClick={() =>
                      setSettings({ ...settings, resolution: "480p" })
                    }
                  >
                    480p
                  </button>
                  <button
                    className={`setting-toggle ${
                      settings.resolution === "720p" ? "active" : ""
                    }`}
                    onClick={() =>
                      setSettings({ ...settings, resolution: "720p" })
                    }
                  >
                    720p
                  </button>
                  <button
                    className={`setting-toggle ${
                      settings.resolution === "1080p" ? "active" : ""
                    }`}
                    onClick={() =>
                      setSettings({ ...settings, resolution: "1080p" })
                    }
                  >
                    1080p
                  </button>
                  <button
                    className={`setting-toggle ${
                      settings.resolution === "4k" ? "active" : ""
                    }`}
                    onClick={() =>
                      setSettings({ ...settings, resolution: "4k" })
                    }
                  >
                    4K
                  </button>
              ...
              <div className="setting-toggles">
                <button
                  ...
                  onClick={() =>
                    setSettings({ ...settings, mirror: !settings.mirror })
                  }
                >
                  Mirror
                </button>
